...
import { useBuilderStore, houseTransformationsMap } from "@/store/useBuilderStore";
...
import HouseTransformationShowcase from "@/components/builders/HouseTransformationShowcase";
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-body pb-24">
      ...
      <div className="section-container mt-8">
        ...
        {/* ─── ARCHITECTURAL TRANSFORMATION & PORTFOLIO ─── */}
        <motion.section
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <HouseTransformationShowcase
            transformation={
              builder.houseTransformation ||
              houseTransformationsMap[`house${(((parseInt(builder.id.replace("builder-", "")) || 1) - 1) % 6) + 1}`] ||
              houseTransformationsMap.house1
            }
          ...
          <div className="flex items-center justify-between mb-8 pt-4">
            <div>
              <h2 className="font-heading italic text-3xl text-slate-900 mb-1">Featured Portfolio</h2>
